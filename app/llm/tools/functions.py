...
async def search_products_by_keywords_like(db: AsyncSession, keywords: list[str]) -> str:
    """
    ...
    search_results = await repository.search_products_by_keywords_like(db=db, keywords=keywords)
